    ...
    <li className="flex flex-col items-start">
      ...
      <ul className="flex flex-row justify-between gap-2 mt-2 w-full">
        ...
        <Link href={`/post/${post.id}`}>
          ...
          <div>
            <span className="text-headline-text font-bold">{commentAmount}</span> {formattedCommentsPrefix}
          </div>  
          </Pill>
        </Link>
        </div>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="#94a1b2">
