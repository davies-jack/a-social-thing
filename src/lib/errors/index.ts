...
function createAppError(statusCode: number, message: string, code: string, data?: unknown) {
...
export const AppErrors = {
  BAD_REQUEST: (message: string, data?: unknown) =>
    createAppError(400, message, "BAD_REQUEST", data),
