...
describe("user utils", () => {
  ...
  describe("getFollowerAmount", () => {
    ...
    it("should handle database errors", async () => {
      (mockPrisma.relationships.count as jest.Mock).mockRejectedValueOnce(
  ...
  describe("getFollowersFromUserId", () => {
    ...
    it("should return followers for valid userId", async () => {
      const mockFollowers = [{ followerId: "user1" }, { followerId: "user2" }];
    ...
    it("should handle database errors", async () => {
      (mockPrisma.relationships.findMany as jest.Mock).mockRejectedValueOnce(
        new Error("Database error")
      );
  ...
  describe("getFollowingFromUserId", () => {
    ...
    it("should return following users for valid userId", async () => {
      const mockFollowing = [{ followingId: "user1" }, { followingId: "user2" }];
